...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/radix3/dist/index.mjs';
import * as vue_cjs from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/vue/dist/vue.cjs.js';
import { version, unref } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/vue/dist/vue.cjs.js';
import { createServerHead as createServerHead$1 } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/BlueWhistle/Bluewhistle/frontend/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/BlueWhistle/Bluewhistle/frontend/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\BlueWhistle\\Bluewhistle\\frontend","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\BlueWhistle\\Bluewhistle\\frontend\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\BlueWhistle\\Bluewhistle\\frontend\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\BlueWhistle\\Bluewhistle\\frontend\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\BlueWhistle\\Bluewhistle\\frontend\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _hxiaMryRKE = (function(nitro) {
...
const require$$1 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(vue_cjs);
...
const _65RZBu4Gfd = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_CS0LYR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_CS0LYR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CS0LYR, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css","integrity":"sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN","crossorigin":"anonymous"},{"rel":"stylesheet","href":"https://unpkg.com/vue3-form-wizard/dist/style.css"}],"style":[],"script":[{"src":"https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js","integrity":"sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL","crossorigin":"anonymous"},{"src":"https://unpkg.com/@popperjs/core@2.11.6/dist/umd/popper.min.js","integrity":"sha384-Vkoo8q4ZlXI/OgJtL+8jFxQpDbprD+Ie/4eMTJ55szgG9/QmA/6I1sDBXddjP9EN","crossorigin":"anonymous"},{"src":"https://unpkg.com/vue3-form-wizard"}],"noscript":[],"title":"Blue Whistle"};
...
const getClientManifest = () => import('file://D:/BlueWhistle/Bluewhistle/frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/BlueWhistle/Bluewhistle/frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
