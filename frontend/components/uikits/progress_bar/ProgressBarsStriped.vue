    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h5>Progress Bars Striped</h5><span>Add <code>.progress-bar-striped</code> to any <code>.progress-bar</code>
                    to apply a stripe via CSS gradient over the progress bar’s background color.</span>
            </div>
            <div class="card-body progress-showcase row">
                <div class="col">
                    ...
                    <div class="progress">
                        <div class="progress-bar progress-bar-striped bg-secondary" role="progressbar" style="width: 25%"
