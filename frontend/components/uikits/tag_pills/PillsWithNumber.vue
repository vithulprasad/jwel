    ...
    <div class="col-sm-12 col-md-6">
        <div class="card">
            ...
            <div class="card-body"><span class="badge rounded-pill badge-primary">1</span><span
                    class="badge rounded-pill badge-secondary">2</span>
                <span class="badge rounded-pill badge-success">3</span><span
                    class="badge rounded-pill badge-info">4</span><span
                    class="badge rounded-pill badge-warning">5</span><span
                    class="badge rounded-pill badge-danger">6</span><span
                    class="badge rounded-pill badge-light text-dark">7</span>
