    ...
    <div class="col-xl-2 col-ed-3 d-xxl-block d-sm-none box-col-none">
        <div class="card get-card overflow-hidden">
            <div class="card-header card-no-border">
                ...
                <span class="f-14 f-w-500 f-light">Better Results?</span><a class="btn btn-primary btn-hover-effect"
                    href="#">More details<span class="ms-1">
                        <svg class="fill-icon">
            ...
            <div class="card-body pt-0">
                <div class="get-image text-center">
                    <img class="img-fluid" src="/images/dashboard-3/better.png" alt="leptop with men vector" />
                </div>
            </div>
