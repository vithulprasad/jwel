  ...
  <li class="onhover-dropdown">
    ...
    <div class="chat-dropdown onhover-show-div" :class="{ active: message }">
      ...
      <ul>
        <li>
          <div class="media">
            <img class="img-fluid b-r-5 me-2" src="/images/user/1.jpg" alt="" />
        ...
        <li>
          <div class="media">
            <img class="img-fluid b-r-5 me-2" src="/images/user/2.jpg" alt="" />
            <div class="media-body">
              <h6>Kori Thomas</h6>
        ...
        <li>
          <div class="media">
            <img class="img-fluid b-r-5 me-2" src="/images/user/6.jpg" alt="" />
            <div class="media-body">
              <h6>Ain Chavez</h6>
              <p>Lorem Ipsum is simply dummy...</p>
