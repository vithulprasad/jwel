    ...
    <div class="col-sm-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5>Text as action</h5><span>Use the <code>.action-text</code> class to add dismiss text instead of
                    icon</span>
            </div>
            <div class="card-body dismiss-text">
                ...
                <div class="alert alert-info inverse alert-dismissible fade show" role="alert"><i class="icon-help-alt"></i>
                    ...
                    <button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"><span class="bg-info"
                            aria-hidden="true">dismiss</span></button>
                </div>
