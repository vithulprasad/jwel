    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Blockquotes</h5><span>Add a <code>&lt;footer class="blockquote-footer"&gt;</code> for identifying the
                    source. Wrap the name of the source work in <code>&lt;cite&gt;</code>.</span>
            </div>
            <div class="card-body">
