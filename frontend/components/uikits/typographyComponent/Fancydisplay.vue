<template>
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Headings</h5><span>Use the included utility classes to recreate the small secondary heading text.
                </span>
            </div>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h5>Display headings</h5><span>Traditional heading elements are designed to work best in the meat of your
                    page content. When you need a heading to stand out, consider using a <strong>display heading</strong>—a
                    larger, slightly more opinionated heading style.</span>
            </div>
            <div class="card-body typography">
    ...
    <div class="col-sm-12 col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="txt-secondary">This is Secondary text You can archive this adding <code>.txt-secondary</code>
                    class</p>
