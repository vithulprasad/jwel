globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Node/Bluewhistle/frontend/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://C:/Node/Bluewhistle/frontend/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, readBody, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery } from 'file://C:/Node/Bluewhistle/frontend/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://C:/Node/Bluewhistle/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://C:/Node/Bluewhistle/frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { createFetch as createFetch$1, Headers } from 'file://C:/Node/Bluewhistle/frontend/node_modules/ofetch/dist/node.mjs';
...
import { parseURL, withoutBase, joinURL, withQuery } from 'file://C:/Node/Bluewhistle/frontend/node_modules/ufo/dist/index.mjs';
...
import { generateJSON } from 'file://C:/Node/Bluewhistle/frontend/node_modules/@intlify/bundle-utils/index.mjs';
...
storage.mount('i18n', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Node\\Bluewhistle\\frontend\\.nuxt\\i18n","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _zYbQsA = defineEventHandler(async (event) => {
...
const handlers = [
  ...
  { route: '/__i18n__/precompile', handler: _zYbQsA, lazy: false, middleware: false, method: "post" },
