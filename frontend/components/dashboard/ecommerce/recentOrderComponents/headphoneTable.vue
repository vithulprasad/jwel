            ...
            <tbody>
                    ...
                    <td>
                        <div class="product-content">
                            <div class="order-image">
                                <img src="/images/dashboard-2/order/sub-product/1.png" alt="headephones" />
                            </div>
                            <div>
                                <h6 class="f-14 mb-0">
                                    <a>
                                        <NuxtLink to="/ecommerce/order/history">Sony</NuxtLink>
                                    </a>
                                </h6>
                ...
                <tr>
                    <td>
                        <div class="product-content">
                            <div class="order-image">
                                <img src="/images/dashboard-2/order/sub-product/2.png" alt="headephones" />
                            </div>
                            <div>
                                <h6 class="f-14 mb-0">
                                    <a>
                                        <NuxtLink to="/ecommerce/order/history">Sennheiser</NuxtLink>
                                    </a>
                                </h6>
