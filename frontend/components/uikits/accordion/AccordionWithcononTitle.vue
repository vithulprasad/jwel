    ...
    <div class="col-sm-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5>Accordion With Icon on Title</h5><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along with icon class
            ...
            <div class="card-body">
                        ...
                        <div class="card-header bg-primary" id="heading11">
                            <h5 class="mb-0">
                                <button class="btn btn-link text-white" data-bs-toggle="collapse"
                                    data-bs-target="#collapse11" aria-expanded="true" aria-controls="collapse11"><i
                        ...
                        <div class="card-header bg-primary" id="heading22">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed text-white" data-bs-toggle="collapse"
                                    data-bs-target="#collapse22" aria-expanded="false" aria-controls="collapse22"><i
                                        class="icofont icofont-support"></i>Collapsible Group Item #<span>2</span></button>
                            </h5>
                        </div>
                ...
                <div class="card">
                    <div class="card-header bg-primary" id="heading33">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed text-white" data-bs-toggle="collapse"
                                data-bs-target="#collapse44" aria-expanded="false" aria-controls="collapse44"><i
