    ...
    <div class="col-sm-12 col-lg-6">
        <div class="card height-equal">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-secondary outline alert-dismissible fade show d-flex" role="alert"><i
                        data-feather="heart">
                ...
                <div class="alert alert-success outline alert-dismissible fade show d-flex" role="alert"><i
                ...
                <div class="alert alert-info outline alert-dismissible fade show d-flex" role="alert"><i
                ...
                <div class="alert alert-warning outline alert-dismissible fade show d-flex" role="alert"><i
                        data-feather="bell">
                ...
                <div class="alert alert-danger outline alert-dismissible fade show d-flex" role="alert"><i
                ...
                <div class="alert alert-light outline alert-dismissible fade show d-flex" role="alert"><i
                ...
                <div class="alert alert-dark outline alert-dismissible fade show d-flex" role="alert"><i
