            ...
            <tbody>
                    ...
                    <td>
                        <div class="product-content">
                            <div class="order-image">
                                <img src="/images/dashboard-2/order/sub-product/5.png" alt="television" />
                            </div>
                            <div>
                                <h6 class="f-14 mb-0">
                                    <a>
                ...
                <tr>
                    <td>
                        <div class="product-content">
                            <div class="order-image">
                                <img src="/images/dashboard-2/order/sub-product/6.png" alt="television" />
                            </div>
                            <div>
                                <h6 class="f-14 mb-0">
                                    <a>
                                        <NuxtLink to="/ecommerce/order/history">Samsung</NuxtLink>
                                    </a>
                                </h6>
